...
# using Geom_density_ridges plot we can visualize the spread of gdpPercap between continents. Based on this plot we can say Ocenia and Europe have more variability of gdpPercapita between their countries. In contrast Asia, Africa and Americas show a narrow spread. Also distributions of all continents are skewed to the left. 
